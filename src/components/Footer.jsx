...
function Footer() {
  return (
    <div className='flex flex-col lg:block  px-[24px] md:px-[39px] lg:px-[165px] mt-[5rem] bg-black pb-8 '>
        <div>
        <div className='border-4 border-[#d87d4a] ml-[35%] md:ml-0 w-[6rem]  mb-8 lg:mb-20'></div>
        <div className='flex flex-col lg:flex-row justify-between '>
        <img className='px-15  md:px-0 mb-4 md:mb-8 lg:mb-0'src={logo} />
        <div>
            <ul className=" flex flex-col md:flex-row gap-3 md:gap-6 text-[#FFFFFF] font-bold text-center">
        ...
        <p className='text-[#979797] lg:w-1/2 mt-8 lg:mt-10 cursor-default text-center md:text-left'>Audiophile is an all in one stop to fulfill your audio needs. 
        ...
        <div className='flex flex-col md:flex-row justify-between  items-center lg:items-start cursor-default'>
            <p className='text-[#979797] mt-8 lg:mt-10'>
