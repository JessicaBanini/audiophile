    ...
    <section className=''>
      ...
      <section  className=' px-[24px] md:px-[39px] lg:px-[165px]'>
        ...
        <div className='   flex flex-col text-center  items-center lg:items-start lg:text-left '>
          ...
          <p className='text-gray-50  text-5xl md:text-6xl lg:w-[50%] md:w-[55%] 2xl:text-8xl 2xl:mb-8 mb-5'>XX99 MARK II HEADPHONES</p>
      ...
      <div className='bg-[#D87D4A] rounded-lg  w-full lg:h-[32rem] 2xl:h-[39.5rem]  flex justify-center items-center lg:items-start  absolute  -z-4'>
        ...
        <div className=' h-[0%] max-w-[22rem] lg:max-w-[24rem] lg:ml-[-5rem] ' >
          <p className='font-bold text-5xl 2xl:text-6xl lg:w-1/2 lg:mt-8 2xl:mt-15 2xl:mb-8 mb-4 '>ZX9 SPEAKER</p>
          <p className=' lg:w-full 2xl:mb-8 2xl:text-lg mb-4 '>
