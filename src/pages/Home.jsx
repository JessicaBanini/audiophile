    ...
    <section className=''>
      ...
      <section  className=' px-[24px] md:px-[39px] lg:px-[165px]'>
        ...
        <div className='   flex flex-col text-center  items-center lg:items-start lg:text-left '>
          <p className='text-[#979797] text-sm mb-4 tracking-[10px]'>NEW PRODUCT</p>
      ...
      <div className='bg-[#D87D4A] rounded-lg  w-full lg:h-[30rem] 2xl:h-[40.5rem]  flex justify-center items-center lg:items-start  absolute  -z-4'>
        <img src={circlePattern} className=' absolute -z-5 top-[-1rem] lg:top-[-2rem] lg:left-[-15rem]' alt="" />
        
        <div className='lg:flex mt-[5rem] lg:mt-[7rem] text-gray-50 '>
        <img src={speakerThumbnail} className=' z-10 w-4xl 2xl:w-4xl ' alt="" />
        <div className='border-2 border-red-600 h-[0%] flex flex-col justify-center items-center text-center lg:items-start text-start'>
          <h1 className='font-bold  border-2 text-5xl 2xl:text-6xl w-1/2 lg:mt-8 2xl:mt-15 2xl:mb-8 mb-4 text-center'>ZX9 SPEAKER</h1>
          <p className='w-[14rem] lg:w-2/3 2xl:w-1/2 2xl:mb-8 2xl:text-lg mb-4 border-2'>
            Upgrade to premium speakers that are phenomenally built to deliver truly remarkable sound.
          </p>
          <button className='bg-[#000000] font-bold text-gray-50 py-2.5 2xl:py-4 px-8'>SEE PRODUCT</button>
